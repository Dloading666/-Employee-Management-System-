    ...
    <div class="row no-gutters">
        <div class="col-2 sidebar">
            <ul class="nav flex-column mt-3" id="menuList">
                ...
                <li class="nav-item admin-menu"><a class="nav-link" href="#" onclick="loadPage('${pageContext.request.contextPath}/employee/list', this)">员工管理</a></li>
                <li class="nav-item admin-menu"><a class="nav-link" href="#" onclick="loadPage('${pageContext.request.contextPath}/user/list', this)">用户管理</a></li>
